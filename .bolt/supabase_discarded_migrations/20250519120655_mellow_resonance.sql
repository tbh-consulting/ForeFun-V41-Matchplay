/*
  ...
  1. Changes
     - Simplifies the match play total calculation to update all teams in a single operation
     - Ensures all teams with the same scorecard_id are updated when any score changes
     - Fixes the issue where team match play totals weren't being properly updated
