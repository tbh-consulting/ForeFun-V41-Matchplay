/*
  ...
  1. New Functions
    - `initialize_team_scores`: Creates scorecard_team_scores entries for each hole
    - `update_team_score_points`: Calculates points based on gross score and handicap
    - `update_team_total_gross_score`: Updates team's total gross score
    - `update_team_total_points`: Updates team's total points
    - `update_team_completed_holes`: Tracks completed holes for teams
    - `calculate_team_relative_score`: Calculates team's score relative to par

  2. Triggers
    - Add triggers to update team statistics when scores change
    - Ensure handicap strokes are properly calculated
*/
