...
DROP FUNCTION IF EXISTS update_team_score_points();
DROP FUNCTION IF EXISTS update_team_total_gross_score();
DROP FUNCTION IF EXISTS update_team_total_points();
DROP FUNCTION IF EXISTS update_team_completed_holes();
DROP FUNCTION IF EXISTS calculate_team_relative_score();
DROP FUNCTION IF EXISTS initialize_team_scores(uuid, uuid, numeric);
