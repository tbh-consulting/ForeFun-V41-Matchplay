/*
  ...
  1. Changes
     - Fix the team match play total calculation to sum all match play statuses for a team
     - Add a function to handle team score deletion and update match play totals
     - Add a utility function to recalculate all match play totals
