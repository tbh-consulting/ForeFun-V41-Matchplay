-- Add columns for hole distances in yards and allow null strokes
...
-- Add columns for hole information
ALTER TABLE scorecard_scores
ADD COLUMN IF NOT EXISTS hole_par integer,
ADD COLUMN IF NOT EXISTS hole_si integer,
ADD COLUMN IF NOT EXISTS hole_distance_black_meters integer,
ADD COLUMN IF NOT EXISTS hole_distance_white_meters integer,
ADD COLUMN IF NOT EXISTS hole_distance_yellow_meters integer,
ADD COLUMN IF NOT EXISTS hole_distance_blue_meters integer,
ADD COLUMN IF NOT EXISTS hole_distance_red_meters integer,
ADD COLUMN IF NOT EXISTS hole_distance_black_yards integer,
ADD COLUMN IF NOT EXISTS hole_distance_white_yards integer,
ADD COLUMN IF NOT EXISTS hole_distance_yellow_yards integer,
ADD COLUMN IF NOT EXISTS hole_distance_blue_yards integer,
ADD COLUMN IF NOT EXISTS hole_distance_red_yards integer;
...
BEGIN
  ...
  FOR v_hole IN (
    ...
    INSERT INTO scorecard_scores (
      ...
      p_player_id,
      v_hole.hole_number,
      NULL, -- Initialize strokes as NULL
