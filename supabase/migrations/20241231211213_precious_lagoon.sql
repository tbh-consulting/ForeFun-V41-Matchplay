-- Add columns for hole distances in yards
ALTER TABLE scorecard_scores
ADD COLUMN hole_distance_black_yards integer,
ADD COLUMN hole_distance_white_yards integer,
ADD COLUMN hole_distance_yellow_yards integer,
ADD COLUMN hole_distance_blue_yards integer,
ADD COLUMN hole_distance_red_yards integer;

-- Update initialize_player_scores function to include both meters and yards
