-- Drop the activities table and related objects
...
DROP FUNCTION IF EXISTS handle_course_created();
DROP FUNCTION IF EXISTS handle_scorecard_created();
DROP FUNCTION IF EXISTS handle_friend_added();
DROP FUNCTION IF EXISTS handle_course_reviewed();

-- Recreate the create_scorecard function without activity tracking
